...
from automation import claim_cli, cli_help, config_cli, continuation, continuation_recovery, dogfood_cli, manage_cli, notification_cli, obligations_cli, opencode_adapter_contract, privacy_grant_cli, product_runtime, revision_cli, scheduler_health_cli, semver_intent, tui_cli, ux_cli, ux_help
...
def _dispatch(
    ...
    *,
    ...
    if command == "roadmap":
        return dogfood_cli.run_cli(rest)
    if command == "privacy":
